...
/** 
 * DAO for table PICTURE_CACHE.
*/
public class PictureCacheDao extends AbstractDao<PictureCache, Long> {

    public static final String TABLENAME = "PICTURE_CACHE";

    /**
     * Properties of entity PictureCache.<br/>
    ...
    */
    ...
    public PictureCacheDao(DaoConfig config) {
        super(config);
    }
    
    public PictureCacheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PICTURE_CACHE' (" + //
