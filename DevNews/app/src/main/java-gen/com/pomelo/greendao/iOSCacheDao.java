...
/** 
 * DAO for table I_OSCACHE.
*/
public class iOSCacheDao extends AbstractDao<iOSCache, Long> {

    public static final String TABLENAME = "I_OSCACHE";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'I_OSCACHE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'I_OSCACHE'";
        db.execSQL(sql);
    }
