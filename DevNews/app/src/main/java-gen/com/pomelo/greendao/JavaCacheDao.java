...
/** 
 * DAO for table JAVA_CACHE.
*/
public class JavaCacheDao extends AbstractDao<JavaCache, Long> {

    public static final String TABLENAME = "JAVA_CACHE";

    /**
     * Properties of entity JavaCache.<br/>
    ...
    */
    ...
    public JavaCacheDao(DaoConfig config) {
        super(config);
    }
    
    public JavaCacheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'JAVA_CACHE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'JAVA_CACHE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, JavaCache entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public JavaCache readEntity(Cursor cursor, int offset) {
        JavaCache entity = new JavaCache( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, JavaCache entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(JavaCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(JavaCache entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
