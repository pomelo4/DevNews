...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        AndroidCacheDao.createTable(db, ifNotExists);
        iOSCacheDao.createTable(db, ifNotExists);
        JavaCacheDao.createTable(db, ifNotExists);
        PythonCacheDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        AndroidCacheDao.dropTable(db, ifExists);
        iOSCacheDao.dropTable(db, ifExists);
        JavaCacheDao.dropTable(db, ifExists);
        PythonCacheDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AndroidCacheDao.class);
        registerDaoClass(iOSCacheDao.class);
        registerDaoClass(JavaCacheDao.class);
        registerDaoClass(PythonCacheDao.class);
